...
TARGET_ARCH="amd64"
TARGET_NAME="anduinos-gnome-shell-with-calamares"
TARGET_BUSINESS_NAME="AnduinOS-Gnome-Shell-With-Calamares"
TARGET_HOSTNAME="anduinos-gnome-shell-with-calamares"
